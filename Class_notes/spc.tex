...
The basic construction of the previous control charts was to choose some test statistic that is sensitive to the signal (read-alternative hypothesis) we seek, derive its sampling distribution, and plot it against some control limits. 
From the hypothesis testing literature we know that we can test hypotheses using some test-statistic, or convert the statistic to p-value scale and make the same inference. 
