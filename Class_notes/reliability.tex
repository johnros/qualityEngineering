...
I will not discuss how to choose $J$, but merely note, that once $J$ has been chosen, the estimation of the failure rate can again be done using a maximum likelihood approach.
