...
\begin{theorem}[Exact point availability]
	Denoting by $M^\circ(t)$ the expected number of repairs until time $t$ we have that
\begin{align}
	A(t)=(1-F(t)) + (1-F(t)) \conv M^\circ(t).
\end{align}
\end{theorem}
But perhaps a more interesting and intuitive result regards the availability at the steady state of the system
...
%\begin{theorem}
%Denote the expected number of failures until time $t$ by $M(t)=M([0,t])$. 
%We have that 
%\begin{align}
