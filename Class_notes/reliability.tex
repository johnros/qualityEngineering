...
\section{Terminology}
\begin{description}
\item [Binary system] A system which may be in one of two states: \emph{functioning} and \emph{failure}. 
\item [Death] In the \emph{survival anlysis} literature, the \emph{failure} state is termed a \emph{death} (for obvious reasons).
\end{description}
...
\subsection{Reliability Analysis- A Static View}
...
\subsection{The Time Evolution of Reliability}
